namespace Core.Upgrades
{
    public class StatPresenter
    {
        ...
        public int PowerCost => _upgradesUpgradesConfig.PowerList[_statLevelSaver.PowerLevel].Cost;
        public int SpeedCost => _upgradesUpgradesConfig.SpeedList[_statLevelSaver.SpeedLevel].Cost;
        public int ArmorCost => _upgradesUpgradesConfig.ArmorList[_statLevelSaver.ArmorLevel].Cost;
    }
}